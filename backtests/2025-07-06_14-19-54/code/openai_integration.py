...
class OpenAITradingAssistant:
    ...
    def analyze_market_sentiment(
        self, market_data: Dict, news_headlines: List[str] = None
    ) -> Dict:
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a professional forex market analyst. Provide concise, accurate analysis.",
                    },
    ...
    def generate_trading_insights(
        self, symbol: str, technical_signals: Dict, market_context: Dict
    ) -> Dict:
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are an expert forex trader. Provide actionable trading advice.",
                    },
                    {"role": "user", "content": prompt},
                ],
                max_tokens=400,
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a forex news analyst. Assess news impact on currency pairs.",
                    },
                    {"role": "user", "content": prompt},
                ],
                max_tokens=300,
    ...
    def _prepare_market_context(
        self, market_data: Dict, news_headlines: List[str]
    ) -> str:
...
class EnhancedForexStrategy:
    ...
    def generate_enhanced_signal(
        self, symbol: str, technical_data: Dict, news_headlines: List[str] = None
    ) -> Dict:
    ...
    def _generate_technical_signal(self, data: Dict) -> Dict:
        ...
        return {"signal": signal, "confidence": min(abs(score), 0.9), "score": score}

    def _combine_signals(
        self, technical: Dict, sentiment: Dict, insights: Dict
    ) -> Dict:
