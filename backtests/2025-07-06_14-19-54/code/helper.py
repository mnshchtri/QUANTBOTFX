...
class StochRSITrendEvaluator:
    ...
    def __init__(
        self, algorithm, symbol, period=14, k_period=3, d_period=3, resolution=None
    ):
    ...
    def evaluate(self):
        ...
        if k_value > d_value and k_value > 20 and d_value > 20:
            if (
                self.previous_k is not None
                and self.previous_d is not None
                and k_value > 90
                and d_value > 90
                and self.previous_k > 90
                and self.previous_d > 90
            ):
            ...
            if (
                ...
                and k_value < 10
                and d_value < 10
                and self.previous_k < 10
                and self.previous_d < 10
            ):
